...
static const char *fonts[]          = { "CaskaydiaCove Nerd Font Mono:size=11" };
static const char dmenufont[]       = "CaskaydiaCove Nerd Font Mono:size=11";
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_evergreen,  col_yellow},
};
